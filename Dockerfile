...
RUN apt-get update  &&\
apt-get install -y alien unixodbc unixodbc-dev python3-pip  &&\
...
wget -O $REDASH_BASE_PATH/redash/query_runner/dremio_odbc.py "https://raw.githubusercontent.com/Dezota/DremioDSforRedash/master/dremio_odbc.py" &&\
